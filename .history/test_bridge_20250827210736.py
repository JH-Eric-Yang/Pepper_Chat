...
def test_bridge_tts():
    ...
    TEST_MESSAGE = "It sounds like you’re curious about something in particular! Are you wondering about how technology works or maybe something specific happening in the news? Let's dive into it together! What’s on your mind?"
